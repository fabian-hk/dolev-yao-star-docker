...
let api_request comm_keys_ids client server =
  ...
  return (Some ({the_id=0}, 0)) // TODO replace with actual values, e.g. return (Some (sid, msg_id))
...
let api_server comm_keys_ids server msg_id =
  ...
  return (Some 0) // TODO replace with actual values, e.g. return (Some msg_id_out)
